...
BASICSR_JIT = 'false'
if BASICSR_JIT == 'false':
    from torch.utils.cpp_extension import load
    module_path = os.path.dirname(__file__)
    deform_conv_ext = load(
        'deform_conv',
        sources=[
            os.path.join(module_path, 'ops', 'deform_conv_ext.cpp'),
            os.path.join(module_path, 'ops', 'deform_conv_cuda.cpp'),
            os.path.join(module_path, 'ops', 'deform_conv_cuda_kernel.cu'),
        ],
    )
else:
    try:
